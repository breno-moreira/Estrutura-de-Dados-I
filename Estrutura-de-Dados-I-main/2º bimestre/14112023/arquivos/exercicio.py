""" with open ('/home/libertas/Documentos/Estrutura-de-Dados-I-main/2º bimestre/14112023/arquivos/entrada.txt', 'r') as arquivo:
...
def soma_valores_arquivo():
    valores = leitura("/home/libertas/Documentos/Estrutura-de-Dados-I-main/2º bimestre/14112023/arquivos/entrada.txt")
    return sum(valores)
